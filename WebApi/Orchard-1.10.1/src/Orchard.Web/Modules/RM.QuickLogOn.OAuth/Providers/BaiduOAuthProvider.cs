...
namespace RM.QuickLogOn.OAuth.Providers
{
    ...
    public class BaiduOAuthProvider : IQuickLogOnProvider
    {
        public const string Url = "https://openapi.baidu.com/oauth/2.0/authorize?client_id={0}&redirect_uri={1}&response_type=code&state={2}{3}";
        ...
        public string GetLogOnUrl(WorkContext context)
        {
            ...
            var part = context.CurrentSite.As<BaiduSettingsPart>();
            ...
            var redirectUrl = new Uri(returnUrl, urlHelper.Action("Auth", "BaiduOAuth", new { Area = "RM.QuickLogOn.OAuth" })).ToString();
