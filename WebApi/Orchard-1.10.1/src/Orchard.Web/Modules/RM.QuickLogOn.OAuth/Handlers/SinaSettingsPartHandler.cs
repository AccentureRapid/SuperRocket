...
namespace RM.QuickLogOn.OAuth.Handlers
{
    ...
    public class SinaSettingsPartHandler : ContentHandler
    {
        public Localizer T { get; set; }

        public SinaSettingsPartHandler(IRepository<SinaSettingsPartRecord> repository)
        {
            Filters.Add(new ActivatingFilter<SinaSettingsPart>("Site"));
