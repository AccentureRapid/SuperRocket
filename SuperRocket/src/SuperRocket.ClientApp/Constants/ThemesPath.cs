...
namespace SuperRocket.ClientApp.Constants
{
    public struct ThemesPath
    {
        ...
        public const string MacOSX = "/Themes/MacOSXTheme.xaml";
    }
}
