...
namespace SuperRocket.Framework.Extensions.Loaders
{
    /// <summary>
    /// 扩展探测条目。
    /// </summary>
    ...
    public interface IExtensionLoader
    {
        ...
        void ExtensionRemoved(ExtensionLoadingContext context, FileSystems.Dependencies.DependencyDescriptor dependency);
        ...
        IEnumerable<ExtensionCompilationReference> GetCompilationReferences(FileSystems.Dependencies.DependencyDescriptor dependency);
        ...
        IEnumerable<string> GetVirtualPathDependencies(FileSystems.Dependencies.DependencyDescriptor dependency);
    }
}