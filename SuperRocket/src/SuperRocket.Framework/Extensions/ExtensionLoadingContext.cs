...
namespace SuperRocket.Framework.Extensions
{
    ...
    public sealed class ExtensionLoadingContext
    {
        ...
        public ExtensionLoadingContext()
        {
            ...
            NewDependencies = new List<FileSystems.Dependencies.DependencyDescriptor>();
        }
        ...
        /// 新的依赖信息集合。
        /// </summary>
        public IList<FileSystems.Dependencies.DependencyDescriptor> NewDependencies { get; private set; }
        ...
        /// 之前成功运行的扩展。
        /// </summary>
        public List<FileSystems.Dependencies.DependencyDescriptor> PreviousDependencies { get; set; }

        /// <summary>
        /// 需要删除的扩展。
        /// </summary>
        public List<FileSystems.Dependencies.DependencyDescriptor> DeletedDependencies { get; set; }
