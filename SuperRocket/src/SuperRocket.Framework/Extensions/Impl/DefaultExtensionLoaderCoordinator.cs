...
using SuperRocket.Framework.Localization;
using SuperRocket.Framework.Logging;
using SuperRocket.Framework.Utility;
using System;
...
namespace SuperRocket.Framework.Extensions.Impl
{
    internal sealed class DefaultExtensionLoaderCoordinator : IExtensionLoaderCoordinator
    {
        ...
        private void ProcessExtension(ExtensionLoadingContext context, ExtensionDescriptorEntry extension)
        {
            ...
            if (activatedExtension != null)
            {
                context.NewDependencies.Add(new FileSystems.Dependencies.DependencyDescriptor
                {
                    Name = extension.Id,
